...
// Generated 22-Apr-2021 17:06:17
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"PID_enable_ROS2020b\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(PID_enable_ROS2020b_M, (NULL));
        PID_enable_ROS2020b_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(PID_enable_ROS2020b_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(PID_enable_ROS2020b_M)
                == (NULL)) || rtmGetStopRequested(PID_enable_ROS2020b_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(PID_enable_ROS2020b_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
